...
**Important:** This plugin is intended for use with the pre-release core application, version 1.0.0. The GUI should be compiled from the [`development-juce8`](https://github.com/open-ephys/plugin-gui/tree/development-juce8) branch, rather than the `master` branch.
